    ...
    try {
        ...
        while (1) {
            ...
            while (1) {
                ...
                // work of reading and writing the stream, but will return on
                // eof, which we'll get when client goes away.
                //
...
void setUpDebugLogging(const char *logname, int argc, char *argv[]) {
    ...
    //
    c150debug->enableLogging(C150RPCDEBUG | C150APPLICATION |
